...
class MD_parameters:
    ...
    tau_short = 0.0001                                 # short time step for label
    append_strike = 2                                  # number of short steps to make one long step
    niter_tau_long  = 6                                # number of MD steps for long tau
    save2file_strike = 4                               # number of short steps to save to file
