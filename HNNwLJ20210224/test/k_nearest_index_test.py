...
if __name__ == '__main__':
    ...
    print(k_nearest_coord_nparticle)
    print(k_nearest_coord_nparticle.shape)

    print(U.shape)
    # print(k_nearest_coord_nparticle[:,:,:,0],  k_nearest_coord_nparticle[:,:,:,1])
    ...
    print(k_nearest_distance_nparticle * predict_k_nearest_force)
    print((k_nearest_distance_nparticle * predict_k_nearest_force ).shape)
    print(torch.sum(k_nearest_distance_nparticle * predict_k_nearest_force, dim=-1))
    print(z_l * torch.sum(k_nearest_distance_nparticle * predict_k_nearest_force, dim=-1))
