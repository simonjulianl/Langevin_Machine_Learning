...
class check4particle_crash:
    ...
    def check(self, phase_space, hamiltonian, tau):
        ...
        # energy_per_particle.shape is [nsmaples]
        ...
        if crash_flag == True:
            ...
            q_list_back, p_list_back = self.backward_method(hamiltonian, phase_space, tau, boxsize)

            all_q = q_list_back[all_idx]
            all_p = p_list_back[all_idx]
