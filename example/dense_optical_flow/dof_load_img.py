...
def compute_dense_optical_flow(prev_image, current_image):
  ...
  flow = cv2.calcOpticalFlowFarneback(prev=prev_image,
                                      ...
                                      pyr_scale=0.85, levels=7, winsize=13,
...
frame1 = cv2.imread('Optical-Flow/teddy1.png',0)
frame2 = cv2.imread('Optical-Flow/teddy2.png',0)
...
def compute_color(u, v):
    ...
    NAN_idx = np.isnan(u) | np.isnan(v)  # or
