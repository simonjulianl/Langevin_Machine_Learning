...
class MD_learner:
    ...
    def train_valid_epoch(self, save_path, best_model_path, loss_curve):
        ...
        print(nsamples_batch, self._tau_cur, MD_iterations)
        ...
        for e in range(1, ML_parameters.nepoch + 1 ):
            ...
            for i in range(0, random_ordered_train_nsamples, nsamples_batch):
                ...
                # time
                q_train_pred, p_train_pred = self.linear_integrator.step( self.any_HNN, self._phase_space, MD_iterations, nsamples_batch, self._tau_cur)
            ...
            with torch.no_grad():
                ...
                for j in range(0, random_ordered_valid_nsamples, nsamples_batch):
                    ...
                    q_valid_label_batch = q_valid_label_batch.to(self._device)
                    p_valid_label_batch = p_valid_label_batch.to(self._device)
                    ...
                    q_valid_pred, p_valid_pred = self.linear_integrator.step( self.any_HNN, self._phase_space, MD_iterations, nsamples_batch, self._tau_cur)
            ...
            train_loss_avg = train_loss / nsamples_batch
            valid_loss_avg = valid_loss / nsamples_batch
