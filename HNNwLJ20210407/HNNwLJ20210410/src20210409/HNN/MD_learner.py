...
class MD_learner:
    ...
    def __init__(self, linear_integrator_obj, 
        ...
        self.trainset_len = self.data_loader.data_set.train_set.qp_list_input.shape[0]
        # self.validset_len = self.data_loader.data_set.valid_set.qp_list_input.shape[0]
    ...
    def train_one_epoch(self):
        ...
        return train_loss / self.trainset_len
    ...
    def valid_one_epoch(self):
        ...
        return valid_loss / self.validset_len
    ...
    def nepoch(self, nepoch, write_chk_pt_filename, write_loss_filename):
        ...
        for e in range(1, nepoch + 1 ):
            ...
            print('{} epoch:'.format(e), 'train_loss:', train_loss, ' each epoch time:', end_epoch - start_epoch)

            text = text + str(e) + ' ' + str(train_loss)  + ' ' + str(end_epoch - start_epoch) + '\n'
