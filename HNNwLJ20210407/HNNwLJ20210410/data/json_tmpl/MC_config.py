...
class MC_config:
    ...
    init_path           = '../data/init_config/n{}run@@/'.format(nparticle)
    filename            = init_path + '../n{}/n{}_nsim_rho0.1T{}_{}_sampled.pt'.format(nparticle, nparticle, temperature, mode)

    seed = 23645                                # set different seed for generate data for train/valid/test
    ...
    nsamples = 2                                # the number of samples for mc
    ...
    dq = 0.03                                   # displacement to increase acceptance rate
