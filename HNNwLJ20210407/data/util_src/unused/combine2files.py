...
if __name__=='__main__':
    '''combine2files need to change combine along dim  
    in init files case , dim = 0 (along nsamples) 
    in trajectory files case, dim = 2 (along trajectory) '''
    ...
    # shape of qp1 is [nsamples, (q, p), trajectory length, nparticle, DIM]

    qp_combine = torch.cat((qp1,qp2), dim=0) # concatenate along trajectory length or along nsmaples
