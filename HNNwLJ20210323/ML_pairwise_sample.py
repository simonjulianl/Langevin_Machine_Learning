...
tau_long_list = MD_parameters.tau_long_list
tau_short_list = MD_parameters.tau_short_list
tau_pair = MD_parameters.tau_pair
lr = ML_parameters.lr
...
MD_iterations = round(MD_parameters.tau_long_list[0] / tau_short_list[0])
iteration_batch = MD_parameters.iteration_batch
iteration_pair_batch = iteration_batch * tau_pair

print('nparticle tau_long tau_short lr nsamples_batch MLP_nhidden')
print(nparticle, tau_long_list, tau_short_list, lr, MD_parameters.nsamples_batch, ML_parameters.MLP_nhidden )
...
prefix = 'nsamples{}_nparticle{}_{}_lr{}_h{}_{}'.format( nsamples, nparticle, optimizer, lr, MLP_nhidden, activation)
...
filename = 'tmp/nparticle{}'.format(nparticle)
