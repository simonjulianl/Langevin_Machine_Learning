...
parser = argparse.ArgumentParser('MD Residue with boltzmann loss and fixed layers')
...
# checking the convolutional weight, in way such that each state is convolved together
print('convolutional weight :', model.conv1d[0].weight.shape)
