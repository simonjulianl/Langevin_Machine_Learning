...
# -*- coding: utf-8 -*-
"""
Created on Fri Apr  3 16:07:09 2020
...
def test():
    ...
    print('L1 Average error position : {:.5f}'.format(pos_diff_expectation)) 
    print('position error variance : {:.5f}'.format(pos2_diff_expectation - pos_diff_expectation ** 2.0)) 
    
    print('L1 Average error velocity : {:.5f}'.format(vel_diff_expectation))
    print('velocity error variance : {:.5f}'.format(vel2_diff_expectation - vel_diff_expectation ** 2.0)) 
